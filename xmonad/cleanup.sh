...
pkill -f ~/.config/xmobar/bluetooth_status.sh
pkill -f ~/.config/xmobar/keyboard_layout.sh
pkill -f ~/.config/xmobar/get_current_brightness.sh
pkill -f ~/.config/xmobar/get_sound_volume.sh
